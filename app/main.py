...
from app.api.v1.routes import admin, admin_document, auth, capability, document, file, health, message, session, user
...
app.include_router(admin_document.router, prefix="/api/v1")
